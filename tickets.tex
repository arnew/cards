...
\put(0,0){{\wb{10mm}{10mm}%
\put(0,95){r}%                       Upper left corner
\multiput(5,95)(10,0){1}{s}%       Upper border
\put(60,95){t}%                     Upper right corner
\multiput(0,90)(0,-10){1}{x}%     Left border
\put(0,0){u}%                    Lower left corner
\multiput(5,0)(10,0){1}{v}%    Lower border
\put(60,0){w}%                  Lower right corner
\multiput(60,90)(0,-10){1}{y}%   Right border
}}%
}
